    ...
    <div class="card-body p-0">
        <table class="table table-hover mb-0">
            <thead class="table-light">
                <tr><th>Name</th><th>Description</th><th>Assets</th><th class="text-end">Actions</th></tr>
            </thead>
            <tbody>
                ...
                @empty
                <tr><td colspan="4" class="text-center py-4 text-muted">No categories yet. <a href="{{ route('categories.create') }}">Add one</a></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
