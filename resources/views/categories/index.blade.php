...
<div class="card" data-bulk-container>
    <div class="card-header">
        ...
        <div class="flex gap-2">
            <form method="POST" action="{{ route('categories.bulk-destroy') }}" data-bulk-form data-confirm-delete data-confirm-title="Delete Selected Categories" data-confirm-message="You are about to permanently delete {count} selected categories. This cannot be undone.">
                @csrf
                @method('DELETE')
            ...
            <form method="POST" action="{{ route('categories.destroy-all') }}" data-confirm-delete data-confirm-title="Delete All Categories" data-confirm-message="You are about to permanently delete ALL categories. This cannot be undone.">
                @csrf
                @method('DELETE')
